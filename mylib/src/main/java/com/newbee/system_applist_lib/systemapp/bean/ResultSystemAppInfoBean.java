...
//        AppInfoShare appInfoShare=PackageManagerUtil.getInstance().getAppInfoShare();
//        if(null==appInfoShare){
//            appList.add(appInfoBean);
//        }else {
//            boolean indexIsExist=false;
//            int index= appInfoShare.getAppIndex(appInfoBean.getPakeageName());
//            if(index==-1){
//                indexIsExist=true;
//            }
//            int maxIndex=-1;
...
//                index=maxIndex+1;
//            }
//            appInfoShare.putAppIndex(appInfoBean.getPakeageName(),index);
